namespace GraphQL
{
    ...
    public static class GraphQLExtensions
    {
        ...
        public static string TrimGraphQLTypes( this string name ) => _trimPattern.Replace( name, string.Empty ).Trim();
...
#pragma warning restore RCS1104 // Simplify conditional expression.
        ...
        public static IEnumerable<string> IsValidLiteralValue( this IGraphType type, IValue valueAst, ISchema schema )
        {
            if ( type is NonNullGraphType nonNull )
            {
                ...
                return valueAst == null || valueAst is NullValue
                    ? ofType != null ? (new[] { $"Expected \"{ofType.Name}!\", found null." }) : (new[] { "Expected non-null value, found null" })
                    : IsValidLiteralValue( ofType, valueAst, schema );
            }
            ...
            if ( type is ListGraphType list )
            {
                ...
                return valueAst is ListValue listValue
                    ? listValue.Values
                        .SelectMany( value =>
            ...
            object parseResult = scalar.ParseLiteral( valueAst );
        ...
        public static bool IsSubtypeOf( this IGraphType maybeSubType, IGraphType superType, ISchema schema )
        {
            ...
            {
                return maybeSubType is NonNullGraphType sub && IsSubtypeOf( sub.ResolvedType, sup1.ResolvedType, schema );
            }
            ...
            {
                return maybeSubType is ListGraphType sub && IsSubtypeOf( sub.ResolvedType, sup.ResolvedType, schema );
            }
            ...
            return superType is IAbstractGraphType type &&
                maybeSubType is IObjectGraphType
                && type.IsPossibleType( maybeSubType );
        }
        ...
        /// </para>
        /// <para>This function is commutative.</para>
        /// </summary>
...
#pragma warning restore RCS1175 // Unused this parameter.
        {
            ...
            return typeA is IAbstractGraphType a
                ? b != null ? a.PossibleTypes.Any( type => b.IsPossibleType( type ) ) : a.IsPossibleType( typeB )
                : b?.IsPossibleType( typeA ) == true;
        }
        ...
        public static IValue AstFromValue( this object value, ISchema schema, IGraphType type )
        {
            ...
            object serialized = inputType.Serialize( value );
